<template>
  <div class="home">
    <div class="index_top">
      <div class="index_top_title">电动车销售系统</div>
    ...
    >
      <el-form ref="formRef" :model="chatForm" class="chat_form">
        ...
        <div class="input_box">
          ...
          />
          <img
            src="http://localhost:8080/electricVehicleMall/file/cd9c0bfe819b47b59b97fd8bfec12f0a.png"
            class="inp_add"
...
.chat_form {
  ...
  .chat-content {
    ...
    margin: 0 0 30px 0;
    background: url(http://localhost:8080/electricVehicleMall/file/974a5cd5eb9840c9b1a4576231567b5c.png);
    overflow-y: scroll;
    height: 300px;
    // 聊天时间
    .chat_time {
